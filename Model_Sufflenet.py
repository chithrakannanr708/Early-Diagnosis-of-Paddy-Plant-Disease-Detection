...
def ShuffleNetV2(include_top=True,
    ...
    name = 'ShuffleNetV2_{}{}{}'.format(scale_factor, bottleneck_ratio, "".join([str(x) for x in num_shuffle_units]))
...
def Model_shufflenet(train_data, train_target, test_data, test_target, sol=None):
    ...
    model = ShuffleNetV2(include_top=True, input_shape=(256, 256, 3), load_model=None,
